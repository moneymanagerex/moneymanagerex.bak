...
// define our own Macro for enabling and disabling Memory leak detection
#define BOOT_ENABLE_STACKWALKER    \
static struct _leaker              \
{                                  \
  _leaker()                        \
...
extern int EnableMemoryTracking(bool bTrack);
