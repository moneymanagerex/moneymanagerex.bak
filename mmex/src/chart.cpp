...
int AbstractChart::GetFrequency(int j)
{
	int k = 1;
    ...
    if (j > 10 && j < 21)
		...
		k = 50;
	else if (j > 200 && j < 1001)
		k = 100;
	else if (j > 1000 && j < 2001)
		k = 500;
	else if (j > 2000 && j < 10001)
		k = 1000;
	else if (j > 10000 && j < 20001)
		k = 5000;
	else if (j > 20000 && j < 0x186a1)
		k = 10000;
	else if (j > 100000 && j < 1000001)
		k = 100000;
	else if (j > 1000000 && j < 10000001)
		k = 1000000;
	else if (j > 10000000 && j < 100000001)
		k = 10000000;
	else if (j > 100000000)
		k = 100000000;
