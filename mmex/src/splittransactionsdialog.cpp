...
void SplitTransactionDialog::CreateControls()
{
    ...
    wxStaticText* headingText = new wxStaticText( itemDialog1, wxID_STATIC, _("Transaction Details"));
    ...
    bottomRowButtonSizer->Add(itemButtonOK, 0, wxALIGN_RIGHT|wxTOP|wxRIGHT, 5);
