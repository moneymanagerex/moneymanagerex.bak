...
enum
{
    ...
    DIALOG_CUSTOM_SQL_BTN_LOAD,
    DIALOG_CUSTOM_SQL_BTN_SAVE,
    DIALOG_CUSTOM_SQL_BTN_QUERY,
    DIALOG_CUSTOM_SQL_BTN_CLEAR,
    DIALOG_CUSTOM_SQL_BTN_CLOSE,
    ...
    ID_DIALOG_TRANSFILTER_DATE_START,
    ID_DIALOG_TRANSFILTER_DATE_END,
    ID_DIALOG_TRANSFILTER_BTN_PAYEE,
    ID_DIALOG_TRANSFILTER_BTN_CATEGORY,
    ID_DIALOG_TRANSFILTER_CH_STATUS,
    ID_DIALOG_TRANSFILTER_CHOICE_TYPE,
    ID_DIALOG_TRANSFILTER_TXT_TRANS_NUM,
    ID_DIALOG_TRANSFILTER_BUTTON_OK,
    ID_DIALOG_TRANSFILTER_BUTTON_CANCEL,
    ...
    ID_BUTTON_BD_EDIT,
    ID_BUTTON_BD_DELETE,
    ID_BUTTON_BD_ENTER_OCCUR,
    ID_BUTTON_BD_SKIP_OCCUR,
    ...
    ID_PANEL_REPORTS_HELP_BUTTON_BACK,
