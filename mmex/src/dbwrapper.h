...
double getAmountForCategory(wxSQLite3Database* db, int categID, int subcategID, bool ignoreDate, const wxDateTime& dtbegin, const wxDateTime& dtEnd, bool evaluateTransfer = false, bool asDeposit = false);
