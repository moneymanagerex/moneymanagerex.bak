...
public:
    TCategoryList(boost::shared_ptr<wxSQLite3Database> db);
    ...
    boost::shared_ptr<TCategoryEntry> GetEntryPtr(const wxString& name);
    boost::shared_ptr<TCategoryEntry> GetEntryPtr(int cat_id);
