...
mmCustomSQLReport::mmCustomSQLReport(wxWindow* parent, mmCoreDB* core, const wxString& reportTitle, const wxString& sqlQuery):
    mmPrintableBase(core), reportTitle_(reportTitle), sqlQuery_(sqlQuery), parent_(parent)
{
}
