...
public:
    ...
    //RecentDatabaseFiles(boost::shared_ptr<MMEX_IniSettings> pIniSettings, int listSize, wxString dbIndexName);
    
    // This constructor is for recent files list
    RecentDatabaseFiles(boost::shared_ptr<MMEX_IniSettings> pIniSettings, wxMenu *menuRecentFiles);
    ~RecentDatabaseFiles();
...
private:
    boost::shared_ptr<MMEX_IniSettings> pIniSettings_;
