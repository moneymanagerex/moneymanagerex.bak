dnl ### begin block 00_header[../../src/tests/mmex_tests.bkl,mmex.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[../../src/tests/mmex_tests.bkl,mmex.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[../../src/tests/mmex_tests.bkl,mmex.bkl] ###
